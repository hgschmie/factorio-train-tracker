...
---@class framework.gui
---@field count              integer A running count for autogenerated names.
...
function FrameworkGui:addTab(parent, child)
    local tab = self:createChildElement(parent, assert(child.tab))
    local gui_element = self:createChildElement(parent, assert(child.content))
...
function FrameworkGui:addChildElements(parent, children, existing_elements)
    ...
    children = #children > 0 and children or { children } --[[@as framework.gui.element_definition[] ]]
